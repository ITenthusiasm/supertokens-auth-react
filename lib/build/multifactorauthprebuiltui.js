...
const FactorChooserFooter = uiEntry.withOverride("MFAFactorChooserFooter", function MFAChooserFooter({ logout }) {
...
const FactorChooserHeader = uiEntry.withOverride("MFAFactorChooserHeader", function MFAFactorChooserHeader(props) {
    const t = translationContext.useTranslation();
    return jsxRuntime.jsx("div", {
...
const FactorOption = uiEntry.withOverride(
    "MFAFactorOption",
    function MFAFactorOption({ onClick, id, name, description, logo }) {
        const t = translationContext.useTranslation();
        return jsxRuntime.jsxs("a", {
            "data-supertokens": `factorChooserOption ${id}`,
            onClick: onClick,
            children: [
                jsxRuntime.jsxs("div", { "data-supertokens": "factorLogo", children: [" ", logo({})] }),
                jsxRuntime.jsxs("div", {
                    "data-supertokens": "factorOptionText",
                    children: [
                        jsxRuntime.jsx("h6", { "data-supertokens": "factorName", children: t(name) }),
                        jsxRuntime.jsx("p", { "data-supertokens": "factorDescription", children: t(description) }),
                    ],
                }),
            ],
        });
...
const FactorList = uiEntry.withOverride(
    "MFAFactorList",
    function MFAFactorList({ availableFactors, navigateToFactor }) {
        return jsxRuntime.jsx("div", {
...
function FactorChooserThemeWrapper(props) {
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            ...
            children: jsxRuntime.jsx(FactorChooserTheme, { ...props }),
        }),
    });
}

const defaultTranslationsMultiFactorAuth = {
    en: {
...
const FactorChooser$1 = (props) => {
    const sessionContext = React.useContext(uiEntry.SessionContext);
    const [mfaInfo, setMFAInfo] = React.useState(undefined);
    let userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
        userContext = props.userContext;
    }
    const recipeComponentOverrides = props.useComponentOverrides();
    const nextQueryParam = genericComponentOverrideContext.getQueryParams("n") ?? undefined;
    ...
    const checkMFAInfo = React.useCallback(
        async (mfaInfo) => {
            setMFAInfo({
    ...
    const navigateToFactor = React.useCallback(
        (factorId) => {
    ...
    const availableFactors = recipe.getAvailableFactors(mfaInfo.factors, nextQueryParam, props.recipe, userContext);
    const childProps = {
    ...
    return jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, {
        ...
        children: jsxRuntime.jsx(uiEntry.FeatureWrapper, {
            ...
            children: jsxRuntime.jsxs(React.Fragment, {
                children: [
                    props.children === undefined && jsxRuntime.jsx(FactorChooserThemeWrapper, { ...childProps }),
                    props.children &&
...
class MultiFactorAuthPreBuiltUI extends uiEntry.RecipeRouter {
    recipeInstance;
    static instance;
    ...
    static getInstanceOrInitAndGetInstance() {
        if (MultiFactorAuthPreBuiltUI.instance === undefined) {
            const recipeInstance = recipe.MultiFactorAuth.getInstanceOrThrow();
    ...
    getFeatures = (useComponentOverrides = componentOverrideContext.useContext) => {
        ...
        if (this.recipeInstance.config.disableDefaultUI !== true) {
            ...
            features[normalisedFullPath.getAsStringDangerous()] = {
                ...
                component: (props) => this.getFeatureComponent("factorchooser", props, useComponentOverrides),
    ...
    getFeatureComponent = (
        ...
        return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
            ...
            children: jsxRuntime.jsx(session.SessionAuth, {
                ...
                children: jsxRuntime.jsx(FactorChooser$1, {
