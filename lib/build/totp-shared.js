...
async function totpCodeValidate(value) {
...
class TOTP extends index.RecipeModule {
    webJSRecipe;
    static instance;
    static RECIPE_ID = "totp";
    recipeID = TOTP.RECIPE_ID;
    constructor(config, webJSRecipe = TOTPWebJS__default.default) {
        super(config);
    ...
    getDefaultRedirectionURL = async (_context) => {
