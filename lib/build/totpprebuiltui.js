...
const RetryButton = ({ nextRetryAt, onClick }) => {
    ...
    const [secsUntilRetry, setSecsUntilRetry] = React.useState(getTimeLeft());
    React.useEffect(() => {
    ...
    return jsxRuntime.jsx("div", {
        ...
        children: jsxRuntime.jsxs("div", {
            ...
            children: [
                ...
                jsxRuntime.jsx("div", { "data-supertokens": "headerTitle", children: t("TOTP_BLOCKED_TITLE") }),
                jsxRuntime.jsx("div", {
...
const BlockedScreen = uiEntry.withOverride("TOTPBlockedScreen", TOTPBlockedScreen);

const TOTPLoadingScreen = () => {
    return jsxRuntime.jsx("div", {
...
const LoadingScreen = uiEntry.withOverride("TOTPLoadingScreen", TOTPLoadingScreen);

const CodeForm = uiEntry.withOverride("TOTPCodeForm", function TOTPCodeForm(props) {
...
const CodeVerificationFooter = uiEntry.withOverride(
    "TOTPCodeVerificationFooter",
    function TOTPCodeVerificationFooter({ onSignOutClicked }) {
        const t = translationContext.useTranslation();
        return jsxRuntime.jsx("div", {
...
const CodeVerificationHeader = uiEntry.withOverride(
...
const DeviceInfoSection = uiEntry.withOverride("TOTPDeviceInfoSection", function TOTPDeviceInfoSection(props) {
    const t = translationContext.useTranslation();
        ...
        children: [
            jsxRuntime.jsxs("div", {
                ...
                children: [
                    ...
                    props.showSecret &&
                        jsxRuntime.jsx("span", { "data-supertokens": "totpSecret", children: props.deviceInfo.secret }),
                ],
            }),
            jsxRuntime.jsx("div", { "data-supertokens": "divider" }),
        ],
...
const DeviceSetupFooter = uiEntry.withOverride(
    "TOTPDeviceSetupFooter",
    function TOTPDeviceSetupFooter({ onSignOutClicked }) {
        const t = translationContext.useTranslation();
        return jsxRuntime.jsx("div", {
...
const DeviceSetupHeader = uiEntry.withOverride("TOTPDeviceSetupHeader", function TOTPDeviceSetupHeader(props) {
    const t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsxs("div", {
...
const TOTPMFATheme = ({ activeScreen, featureState, ...props }) => {
    const t = translationContext.useTranslation();
    const commonProps = {
        featureState,
                          ...
                          jsxRuntime.jsxs(React__namespace.default.Fragment, {
                              children: [
                                  activeScreen === TOTPMFAScreens.DeviceSetup
                                      ? jsxRuntime.jsx(DeviceSetupHeader, {
                                            ...commonProps,
                                            showBackButton: featureState.showBackButton,
                                            onBackButtonClicked: props.onBackButtonClicked,
                                        })
                                      : jsxRuntime.jsx(CodeVerificationHeader, {
                                            ...commonProps,
                                            showBackButton: featureState.showBackButton,
                                            onBackButtonClicked: props.onBackButtonClicked,
                                        }),
                                  activeScreen === TOTPMFAScreens.DeviceSetup &&
                                      jsxRuntime.jsx(DeviceInfoSection, {
                                          ...commonProps,
                                  ...
                                  jsxRuntime.jsx(CodeForm, {
                                      ...commonProps,
                                      onSuccess: props.onSuccess,
                                      footer:
                                          activeScreen === TOTPMFAScreens.DeviceSetup
                                              ? jsxRuntime.jsx(DeviceSetupFooter, {
                                                    ...commonProps,
                                                    onSignOutClicked: props.onSignOutClicked,
                                                })
                                              : jsxRuntime.jsx(CodeVerificationFooter, {
                                                    ...commonProps,
                                                    onSignOutClicked: props.onSignOutClicked,
                                                }),
                                  }),
...
function TOTPMFAThemeWrapper(props) {
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            ...
            children: jsxRuntime.jsx(TOTPMFATheme, { ...props, activeScreen: activeScreen }),
        }),
    });
}
...
function useOnLoad(recipeImpl, dispatch, userContext) {
    const fetchMFAInfo = React__namespace.useCallback(
        async () =>
            recipe$1.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext }),
        [userContext]
    );
    ...
    const onLoad = React__namespace.useCallback(
        async (mfaInfo) => {
            ...
            const alreadySetup = mfaInfo.factors.alreadySetup.includes(types.FactorIds.TOTP);
            ...
            children: jsxRuntime.jsxs(React.Fragment, {
                children: [
                    props.children === undefined &&
                        jsxRuntime.jsx(TOTPMFAThemeWrapper, { ...childProps, featureState: state, dispatch: dispatch }),
                    props.children &&
 ...
 * under the License.
 */
const DEFAULT_TOTP_PATH = "/mfa/totp";

class TOTPPreBuiltUI extends uiEntry.RecipeRouter {
    recipeInstance;
    static instance;
    ...
    static getInstanceOrInitAndGetInstance() {
        if (TOTPPreBuiltUI.instance === undefined) {
            const recipeInstance = recipe.TOTP.getInstanceOrThrow();
    ...
    getFeatures = (useComponentOverrides = recipe.useContext) => {
        ...
        if (this.recipeInstance.config.totpMFAScreen.disableDefaultUI !== true) {
            ...
            features[normalisedFullPath.getAsStringDangerous()] = {
                ...
                component: (props) => this.getFeatureComponent("mfaTOTP", props, useComponentOverrides),
    ...
    getFeatureComponent = (
        ...
        return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
            ...
            children: jsxRuntime.jsx(session.SessionAuth, {
                ...
                children: jsxRuntime.jsx(SignInUpFeature, {
    ...
    static MFATOTP = (props) => TOTPPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatureComponent("mfaTOTP", props);
    static MFATOTPTheme = TOTPMFAThemeWrapper;
}
