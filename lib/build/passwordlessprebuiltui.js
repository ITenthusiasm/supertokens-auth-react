...
const ContinueWithPasswordless = (props) => {
    return jsxRuntime.jsx("div", {
        "data-supertokens": "continueWithPasswordlessButtonWrapper",
        children: jsxRuntime.jsx(formBase.Button, {
            isLoading: false,
            onClick: () => {
...
const ContinueWithPasswordlessWithOverride = uiEntry.withOverride(
    "PasswordlessContinueWithPasswordless",
    ContinueWithPasswordless
);
const ContinueWithPasswordlessTheme = (props) => {
    ...
    return jsxRuntime.jsx(ThemeBase, {
        ...
        children: jsxRuntime.jsx(ContinueWithPasswordlessWithOverride, { ...props }),
    });
};

const ContinueWithPasswordlessFeature = (props) => {
    const recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, {
        recipeComponentOverrides: recipeComponentOverrides,
        children: jsxRuntime.jsx(ContinueWithPasswordlessTheme, {
            ...props,
...
const PasswordlessLinkClickedScreen = (props) => {
...
const LinkClickedScreenWithOverride = uiEntry.withOverride(
    "PasswordlessLinkClickedScreen",
    PasswordlessLinkClickedScreen
);
const LinkClickedScreen$1 = (props) => {
    const rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    const hasFont = uiEntry.hasFontDefined(rootStyle) || uiEntry.hasFontDefined(props.config.recipeRootStyle);
    return jsxRuntime.jsx(ThemeBase, {
        loadDefaultFont: !hasFont,
        userStyles: [rootStyle, props.config.recipeRootStyle, props.config.linkClickedScreenFeature.style],
        children: jsxRuntime.jsx(LinkClickedScreenWithOverride, { ...props }),
    });
};

const defaultTranslationsPasswordless = {
    en: {
...
const LinkClickedScreen = (props) => {
    ...
    const [requireUserInteraction, setRequireUserInteraction] = React.useState(false);
    const consumeCodeAtMount = React.useCallback(async () => {
        const preAuthSessionId = genericComponentOverrideContext.getQueryParams("preAuthSessionId");
        const linkCode = genericComponentOverrideContext.getURLHash();
        if (preAuthSessionId === null || preAuthSessionId.length === 0 || linkCode.length === 0) {
            await genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToAuth({
    ...
    const handleConsumeResp = React.useCallback(
        async (consumeRes) => {
            ...
            if (response.status === "OK") {
                ...
                const loginAttemptInfo = await props.recipe.webJSRecipe.getLoginAttemptInfo({
                    userContext,
                });
    ...
    const handleConsumeError = React.useCallback(
        (err) => {
    ...
    return jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, {
        ...
        children: jsxRuntime.jsx(uiEntry.FeatureWrapper, {
            ...
            children: jsxRuntime.jsxs(React.Fragment, {
                children: [
                    props.children === undefined && jsxRuntime.jsx(LinkClickedScreen$1, { ...childProps }),
                    props.children &&
                        React__namespace.default.Children.map(props.children, (child) => {
...
function SMSLargeIcon() {
    return jsxRuntime.jsx("svg", {
        ...
        children: jsxRuntime.jsx("g", {
            id: "Group_10400",
            "data-name": "Group 10400",
            transform: "translate(-724.625 -241.125)",
            children: jsxRuntime.jsxs("g", {
                id: "Group_10399",
                "data-name": "Group 10399",
                children: [
                    jsxRuntime.jsxs("g", {
                        id: "Group_10398",
                        "data-name": "Group 10398",
                        children: [
                            jsxRuntime.jsxs("g", {
...
const ResendButton = uiEntry.withOverride(
    "PasswordlessResendButton",
    function PasswordlessResendButton({ loginAttemptInfo, resendEmailOrSMSGapInSeconds, onClick }) {
        const t = translationContext.useTranslation();
        ...
        const [secsUntilResend, setSecsUntilResend] = React.useState(getTimeLeft());
        React.useEffect(() => {
...
const PasswordlessLinkSent = (props) => {
    const t = translationContext.useTranslation();
    const userContext = uiEntry.useUserContext();
    const [status, setStatus] = React.useState(props.error !== undefined ? "ERROR" : "READY");
    // Any because node types are included here, messing with return type of setTimeout
    const resendNotifTimeout = React.useRef();
    React.useEffect(() => {
        return () => {
            ...
            children: [
                ...
                jsxRuntime.jsxs("div", {
                    ...
                    children: [
                        ...
                        jsxRuntime.jsx("strong", { children: props.loginAttemptInfo.contactInfo }),
                        props.loginAttemptInfo.contactMethod === "EMAIL"
...
const LinkSent = uiEntry.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);
function LinkSentWrapper(props) {
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            ...
            children: jsxRuntime.jsx(LinkSent, { ...props }),
        }),
    });
}
...
function useChildProps$4(
    ...
    const recipeImplementation = React__namespace.useMemo(
        () => getModifiedRecipeImplementation$4(recipe$1.webJSRecipe, onError, rebuildAuthPage),
...
const LinkSentFeatureInner = (props) => {
    const childProps = useChildProps$4(
        props.recipe,
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(LinkSentWrapper, { ...childProps, userContext: props.userContext }),
            props.children &&
...
const LinkSentFeature = (props) => {
    const recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, {
        recipeComponentOverrides: recipeComponentOverrides,
        children: jsxRuntime.jsx(LinkSentFeatureInner, { ...props }),
    });
};
        ...
        resendCode: async (input) => {
            ...
            if (res.status === "OK") {
                ...
                if (loginAttemptInfo !== undefined) {
                    ...
                    await originalImpl.setLoginAttemptInfo({
                        userContext: input.userContext,
                        attemptInfo: {
                            ...loginAttemptInfo,
 ...
 * under the License.
 */
let phoneNumberUtilsImport;
async function getPhoneNumberUtils() {
    await preloadPhoneNumberUtils();
    const global = windowHandler.WindowHandlerReference.getReferenceOrThrow().windowHandler.getWindowUnsafe();
    return global.intlTelInputUtils;
}
...
async function defaultPhoneNumberValidator(value) {
...
const EmailForm = uiEntry.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    const userContext = uiEntry.useUserContext();
...
function PhoneNumberInput({
    ...
    React.useEffect(() => {
        if (inputRef.current !== null && itiRef.current === null) {
            ...
            const anyIti = itiRef;
            if (anyIti.isMobile) {
                const root = document.getElementById(genericComponentOverrideContext.ST_ROOT_ID);
    ...
    return jsxRuntime.jsxs("div", {
        ...
        children: [
            ...
            jsxRuntime.jsxs("div", {
                "data-supertokens": `phoneInputWrapper inputWrapper ${hasError ? "inputError" : ""}`,
                children: [
...
// TODO: type props
const phoneNumberInputWithInjectedProps = function (injectedProps) {
    return (props) => jsxRuntime.jsx(PhoneNumberInput, { ...injectedProps, ...props });
};

const PhoneForm = uiEntry.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    const userContext = uiEntry.useUserContext();
    React.useEffect(() => {
...
const UserInputCodeFormFooter = uiEntry.withOverride(
    "PasswordlessUserInputCodeFormFooter",
    function PasswordlessUserInputCodeFormFooter({ loginAttemptInfo, recipeImplementation }) {
        const t = translationContext.useTranslation();
        const userContext = uiEntry.useUserContext();
...
const UserInputCodeFormHeader = uiEntry.withOverride(
    "PasswordlessUserInputCodeFormHeader",
    function PasswordlessUserInputCodeFormHeader({ loginAttemptInfo }) {
        const t = translationContext.useTranslation();
        return jsxRuntime.jsxs(React.Fragment, {
            children: [
                jsxRuntime.jsx("div", {
...
const UserInputCodeFormScreen = (props) => {
    return jsxRuntime.jsxs("div", {
        "data-supertokens": "container",
        children: [
            jsxRuntime.jsxs("div", {
                "data-supertokens": "row",
                children: [
                    jsxRuntime.jsx(UserInputCodeFormHeader, { ...props }),
                    props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }),
                    jsxRuntime.jsx(UserInputCodeForm, { ...props }),
                ],
            }),
...
const UserInputCodeForm = uiEntry.withOverride("PasswordlessUserInputCodeForm", (props) => {
    const t = translationContext.useTranslation();
    const userContext = uiEntry.useUserContext();
    // We need this any because the node types are also loaded
    const [clearResendNotifTimeout, setClearResendNotifTimeout] = React.useState();
    React.useEffect(() => {
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [
            ...
            jsxRuntime.jsx(formBase.FormBase, {
                ...
                footer:
                    props.footer ??
                    jsxRuntime.jsx(UserInputCodeFormFooter, { ...props, loginAttemptInfo: props.loginAttemptInfo }),
            }),
        ],
    });
});
function UserInputCodeFormScreenWrapper(props) {
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            loadDefaultFont: !hasFont,
            userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle],
            children: jsxRuntime.jsx(UserInputCodeFormScreen, { ...props }),
        }),
    });
}
...
const LoadingScreen = uiEntry.withOverride("PasswordlessMFAOTPLoadingScreen", OTPLoadingScreen);

const MFAFooter = uiEntry.withOverride("PasswordlessMFAFooter", function PasswordlessMFAFooter(props) {
    const t = translationContext.useTranslation();
    return jsxRuntime.jsx("div", {
...
const MFAHeader = uiEntry.withOverride("PasswordlessMFAHeader", function PasswordlessMFAHeader(props) {
    const t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsxs("div", {
...
const MFAOTPFooter = uiEntry.withOverride(
    "PasswordlessMFAOTPFooter",
    function PasswordlessMFAOTPFooter({ loginAttemptInfo, recipeImplementation, onSignOutClicked, canChangeEmail }) {
        const t = translationContext.useTranslation();
        const userContext = uiEntry.useUserContext();
        return jsxRuntime.jsxs("div", {
...
const MFAOTPHeader = uiEntry.withOverride(
    "PasswordlessMFAOTPHeader",
    function PasswordlessMFAOTPHeader({ showBackButton, loginAttemptInfo, onBackButtonClicked, canChangeEmail }) {
        const t = translationContext.useTranslation();
        return jsxRuntime.jsxs(React.Fragment, {
            children: [
                jsxRuntime.jsxs("div", {
...
const MFATheme = ({ activeScreen, featureState, onBackButtonClicked, ...props }) => {
    const t = translationContext.useTranslation();
    const commonProps = {
        recipeImplementation: props.recipeImplementation,
        config: props.config,
        clearError: () => props.dispatch({ type: "setError", showAccessDenied: false, error: undefined }),
        onError: (error) => props.dispatch({ type: "setError", showAccessDenied: false, error }),
        onFetchError: props.onFetchError,
                      ...
                      children: jsxRuntime.jsxs(React__namespace.default.Fragment, {
                          children: [
                              ...
                              activeScreen === MFAScreens.EmailForm
                                  ? jsxRuntime.jsx(EmailForm, {
                                        ...commonProps,
                                        footer: jsxRuntime.jsx(MFAFooter, {
                                            ...commonProps,
                                  ...
                                  : activeScreen === MFAScreens.UserInputCodeForm
                                  ? jsxRuntime.jsx(UserInputCodeForm, {
                                        ...commonProps,
                                        loginAttemptInfo: featureState.loginAttemptInfo,
                                        onSuccess: props.onSuccess,
                                        footer: jsxRuntime.jsx(MFAOTPFooter, {
                                            ...commonProps,
                                            onSignOutClicked: props.onSignOutClicked,
                                            canChangeEmail: featureState.canChangeEmail,
                                            loginAttemptInfo: featureState.loginAttemptInfo,
...
function MFAThemeWrapper(props) {
    const rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    const hasFont = uiEntry.hasFontDefined(rootStyle) || uiEntry.hasFontDefined(props.config.recipeRootStyle);
    const activeScreen = getActiveScreen$2(props);
    let activeStyle;
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            ...
            children: jsxRuntime.jsx(MFATheme, { ...props, activeScreen: activeScreen }),
        }),
    });
}
...
const useFeatureReducer = () => {
    return React__namespace.useReducer(
        ...
        (initArg) => {
            let error = undefined;
            const errorQueryParam = genericComponentOverrideContext.getQueryParams("error");
...
function useChildProps$3(recipe$1, recipeImplementation, state, contactMethod, dispatch, userContext, navigate) {
    ...
    return React.useMemo(() => {
        return {
            onSuccess: () => {
                const redirectToPath = genericComponentOverrideContext.getRedirectToPathFromURL();
                return types.Session.getInstanceOrThrow()
                    .validateGlobalClaimsAndHandleSuccessRedirection(
                        undefined,
                        recipe$1.recipeID,
            ...
            onSignOutClicked: async () => {
                await types.Session.getInstanceOrThrow().signOut({ userContext });
                await recipeImplementation.clearLoginAttemptInfo({ userContext });
                await uiEntry.redirectToAuth({ redirectBack: false, navigate: navigate });
            },
            ...
            config: recipe$1.config,
            contactMethod,
            validatePhoneNumber: recipe$1.config.validatePhoneNumber ?? defaultPhoneNumberValidator,
        };
    }, [contactMethod, state, recipeImplementation]);
}
const MFAFeatureInner = (props) => {
    const userContext = uiEntry.useUserContext();
    const [state, dispatch] = useFeatureReducer();
    const recipeImplementation = React__namespace.useMemo(
        () =>
            props.recipe && getModifiedRecipeImplementation$3(props.recipe.webJSRecipe, props.recipe.config, dispatch),
        [props.recipe]
    );
    useOnLoad(props, recipeImplementation, dispatch, userContext);
    const childProps = useChildProps$3(
        props.recipe,
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(MFAThemeWrapper, { ...childProps, featureState: state, dispatch: dispatch }),
            props.children &&
                React__namespace.Children.map(props.children, (child) => {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, {
...
const MFAFeature = (props) => {
    ...
    return jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, {
        ...
        children: jsxRuntime.jsx(uiEntry.FeatureWrapper, {
            useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom,
            defaultStore: defaultTranslationsPasswordless,
            children: jsxRuntime.jsx(MFAFeatureInner, { ...props }),
        }),
    });
};
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    const fetchMFAInfo = React__namespace.useCallback(
        async () =>
            recipe$3.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext }),
        [userContext]
    );
    const handleLoadError = React__namespace.useCallback(
    ...
    const onLoad = React__namespace.useCallback(
        async (mfaInfo) => {
            let error = undefined;
            const errorQueryParam = genericComponentOverrideContext.getQueryParams("error");
            const doSetup = genericComponentOverrideContext.getQueryParams("setup");
            if (errorQueryParam !== null) {
                error = "SOMETHING_WENT_WRONG_ERROR";
            }
            let loginAttemptInfo = await recipeImplementation.getLoginAttemptInfo({
                userContext,
            });
            const factorId = props.contactMethod === "EMAIL" ? types.FactorIds.OTP_EMAIL : types.FactorIds.OTP_PHONE;
                ...
                if (contactInfoList.length > 0 && doSetup !== "true") {
                    ...
                    try {
                        ...
                        if (
                            ...
                            const invalidClaims = await session.getInvalidClaimsFromResponse({
                                response: err,
                                userContext,
                            });
                            if (invalidClaims.some((i) => i.id === emailverification.EmailVerificationClaim.id)) {
...
function getModifiedRecipeImplementation$3(originalImpl, config, dispatch) {
    return {
        ...
        createCode: async (input) => {
            ...
            const contactMethod = "email" in input ? "EMAIL" : "PHONE";
...
const EmailOrPhoneForm = uiEntry.withOverride(
    "PasswordlessEmailOrPhoneForm",
    function PasswordlessEmailOrPhoneForm(props) {
        const t = translationContext.useTranslation();
        const [isPhoneNumber, setIsPhoneNumber] = React.useState(!props.config.signInUpFeature.defaultToEmail);
        const userContext = uiEntry.useUserContext();
        React.useEffect(() => {
            // We preload this here, since it will be used almost for sure, but loading it
            void preloadPhoneNumberUtils();
 ...
 * Component.
 */
const SignInUpTheme$1 = ({ activeScreen, ...props }) => {
    const commonProps = {
        recipeImplementation: props.recipeImplementation,
        config: props.config,
        clearError: props.clearError,
    ...
    return activeScreen === SignInUpScreens.EmailForm
        ? jsxRuntime.jsx(EmailForm, { ...commonProps })
        : activeScreen === SignInUpScreens.PhoneForm
        ? jsxRuntime.jsx(PhoneForm, { ...commonProps })
        : activeScreen === SignInUpScreens.EmailOrPhoneForm
        ? jsxRuntime.jsx(EmailOrPhoneForm, { ...commonProps })
        : null;
};
function SignInUpThemeWrapper$1(props) {
    const rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    const hasFont = uiEntry.hasFontDefined(rootStyle) || uiEntry.hasFontDefined(props.config.recipeRootStyle);
    const activeScreen = getActiveScreen$1(props.factorIds);
    let activeStyle;
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            loadDefaultFont: !hasFont,
            userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle],
            children: jsxRuntime.jsx(SignInUpTheme$1, { ...props, activeScreen: activeScreen }),
        }),
    });
}
...
const SignInUpFeatureInner = (props) => {
    let userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
        userContext = props.userContext;
    }
    const childProps = useChildProps$2(
        props.recipe,
        props.factorIds,
        props.error,
        props.onError,
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper$1, { ...childProps }),
            props.children &&
                React__namespace.Children.map(props.children, (child) => {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, {
...
const SignInUpFeature = (props) => {
    const recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, {
        recipeComponentOverrides: recipeComponentOverrides,
        children: jsxRuntime.jsx(SignInUpFeatureInner, { ...props }),
    });
};
...
const ContinueWithPasswordlessFooter = ({
    onError,
    ...
    const state = formBase.useFormFields();
    const t = translationContext.useTranslation();
...
const EPComboEmailForm = uiEntry.withOverride(
            ...
            formFields.push({
                ...
                labelComponent: jsxRuntime.jsxs("div", {
                    ...
                    children: [
                        ...
                        jsxRuntime.jsx("a", {
                            onClick: () =>
                                recipe$1.EmailPassword.getInstanceOrThrow().redirect({ action: "RESET_PASSWORD" }),
...
const EPComboEmailOrPhoneForm = uiEntry.withOverride(
    ...
    function PasswordlessEPComboEmailOrPhoneForm(props) {
        ...
        const formFields = props.isPhoneNumber
            ? [
                  {
                      id: "phoneNumber",
                      label: "",
 ...
 * Component.
 */
const SignInUpTheme = ({ activeScreen, ...props }) => {
    const commonProps = {
        ...props,
    };
    return activeScreen === SignInUpEPComboScreens.EmailForm
        ? jsxRuntime.jsx(EPComboEmailForm, { ...commonProps })
        : activeScreen === SignInUpEPComboScreens.EmailOrPhoneForm
        ? jsxRuntime.jsx(EPComboEmailOrPhoneForm, { ...commonProps })
        : null;
};
function SignInUpThemeWrapper(props) {
    ...
    return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
        ...
        children: jsxRuntime.jsx(ThemeBase, {
            loadDefaultFont: !hasFont,
            userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle],
            children: jsxRuntime.jsx(SignInUpTheme, { ...props, activeScreen: activeScreen }),
        }),
    });
}
...
function useChildProps$1(recipe$2, factorIds, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    const [isPhoneNumber, setIsPhoneNumber] = React__namespace.useState(
        !recipe$2.config.signInUpFeature.defaultToEmail
    );
    const [showPasswordField, setShowPasswordField] = React__namespace.useState(false);
    const [showContinueWithPasswordlessLink, setShowContinueWithPasswordlessLink] = React__namespace.useState(false);
    const rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(() => {
        return {
            isPhoneNumber,
            ...
            onContactInfoSubmit: async (contactInfo) => {
                if (isPhoneNumber) {
                ...
                const [epExists, pwlessExists] = await Promise.all([
                    recipe$1.EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({ email, userContext }),
            ...
            onPasswordSubmit: async (formFields) => {
                const validationErrors = await genericComponentOverrideContext.validateForm(
                    formFields,
                    recipe$1.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields
                );
                ...
                const response = await recipe$1.EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                    formFields,
                    userContext,
                });
                if (response.status === "WRONG_CREDENTIALS_ERROR") {
                    throw new STGeneralError__default$1.default("EMAIL_PASSWORD_SIGN_IN_WRONG_CREDENTIALS_ERROR");
                    ...
                    .validateGlobalClaimsAndHandleSuccessRedirection(
                        {
                            ...
                            newSessionCreated:
                                ...
                                (payloadAfterCall !== undefined &&
                                    session$1.accessTokenPayload.sessionHandle !== payloadAfterCall.sessionHandle),
                            recipeId: result.isEmailPassword ? recipe$1.EmailPassword.RECIPE_ID : recipe$2.recipeID,
                        },
                        result.isEmailPassword ? recipe$1.EmailPassword.RECIPE_ID : recipe$2.recipeID,
                        genericComponentOverrideContext.getRedirectToPathFromURL(),
                        userContext,
                        navigate
                    )
            ...
            validatePhoneNumber: recipe$2.config.validatePhoneNumber ?? defaultPhoneNumberValidator,
        };
    }, [
        error,
        factorIds,
...
const SignInUpEPComboFeatureInner = (props) => {
    let userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
        userContext = props.userContext;
    }
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, { ...childProps }),
            props.children &&
                React__namespace.Children.map(props.children, (child) => {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, {
...
const SignInUpEPComboFeature = (props) => {
    const recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, {
        recipeComponentOverrides: recipeComponentOverrides,
        children: jsxRuntime.jsx(SignInUpEPComboFeatureInner, { ...props }),
    });
};
...
function useChildProps(recipe$1, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    const session$1 = uiEntry.useSessionContext();
    const recipeImplementation = React__namespace.useMemo(
        () => getModifiedRecipeImplementation(recipe$1.webJSRecipe, onError, rebuildAuthPage),
        [recipe$1, onError, rebuildAuthPage]
    );
    const rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(() => {
...
const UserInputCodeFeatureInner = (props) => {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(UserInputCodeFormScreenWrapper, { ...childProps, userContext: props.userContext }),
            props.children &&
                React__namespace.Children.map(props.children, (child) => {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, {
...
const UserInputCodeFeature = (props) => {
    const recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, {
        recipeComponentOverrides: recipeComponentOverrides,
        children: jsxRuntime.jsx(UserInputCodeFeatureInner, { ...props }),
    });
};
...
class PasswordlessPreBuiltUI extends uiEntry.RecipeRouter {
    recipeInstance;
    static instance;
    ...
    static getInstanceOrInitAndGetInstance() {
        if (PasswordlessPreBuiltUI.instance === undefined) {
            const recipeInstance = recipe$2.Passwordless.getInstanceOrThrow();
            PasswordlessPreBuiltUI.instance = new PasswordlessPreBuiltUI(recipeInstance);
        }
        return PasswordlessPreBuiltUI.instance;
    }
    static getFeatures(useComponentOverrides = recipe$2.useContext) {
        return PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatures(useComponentOverrides);
    }
    static getFeatureComponent(componentName, props, useComponentOverrides = recipe$2.useContext) {
    ...
    // Instance methods
    getFeatures = (useComponentOverrides = recipe$2.useContext) => {
        const features = {};
        ...
        if (this.recipeInstance.config.mfaFeature.disableDefaultUI !== true) {
            ...
            features[normalisedFullPathPhone.getAsStringDangerous()] = {
                ...
                component: (props) => this.getFeatureComponent("otp-phone", props, useComponentOverrides),
                recipeID: recipe$2.Passwordless.RECIPE_ID,
            };
            ...
            features[normalisedFullPathEmail.getAsStringDangerous()] = {
                ...
                component: (props) => this.getFeatureComponent("otp-email", props, useComponentOverrides),
                recipeID: recipe$2.Passwordless.RECIPE_ID,
            };
        }
        return features;
    };
    getFeatureComponent = (componentName, props, useComponentOverrides = recipe$2.useContext) => {
        if (componentName === "linkClickedScreen") {
            return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
                ...
                children: jsxRuntime.jsx(session.SessionAuth, {
                    requireAuth: false,
                    doRedirection: false,
                    children: jsxRuntime.jsx(LinkClickedScreen, {
        ...
        if (componentName === "otp-email") {
            return jsxRuntime.jsx(uiEntry.UserContextWrapper, {
                ...
                children: jsxRuntime.jsx(session.SessionAuth, {
                    ...
                    children: jsxRuntime.jsx(MFAFeature, {
                        recipe: this.recipeInstance,
                        useComponentOverrides: useComponentOverrides,
                        contactMethod: "EMAIL",
    ...
    getAuthComponents() {
        ...
        const res = [
            {
                ...
                async preloadInfoAndRunChecks(firstFactors, userContext) {
                    ...
                    let loginAttemptInfo =
                        await recipe$2.Passwordless.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo({
                            userContext,
                        });
                    if (loginAttemptInfo !== undefined) {
                        if (
                            ...
                            await recipe$2.Passwordless.getInstanceOrThrow().webJSRecipe?.clearLoginAttemptInfo({
                                userContext,
                            });
                            loginAttemptInfo = undefined;
                        } else if (
            ...
            ...factorCombos.map((factors) => ({
                ...
                displayOrder: 3,
                component: (props) =>
                    React.createElement(SignInUpFeature, {
                        ...props,
                        key: factors.join("|"),
                        recipe: this.recipeInstance,
                        useComponentOverrides: recipe$2.useContext,
        ...
        try {
            ...
            res.push(
                ...factorCombos
                    .map((combo) => [types.FactorIds.EMAILPASSWORD, ...combo])
                    .map((factors) => ({
                        type: "SIGN_IN",
                        factorIds: factors,
                        displayOrder: 3,
                        component: (props) =>
                            React.createElement(SignInUpEPComboFeature, {
                                ...props,
                                key: factors.join("|"),
                                recipe: this.recipeInstance,
                                useComponentOverrides: recipe$2.useContext,
    ...
    static LinkClicked = (props) => this.getFeatureComponent("linkClickedScreen", props);
    static MfaOtpPhone = (props) => this.getFeatureComponent("otp-phone", props);
    static MfaOtpEmail = (props) => this.getFeatureComponent("otp-email", props);
