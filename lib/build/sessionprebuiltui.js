...
function BackButton({ onClick }) {
    ...
    return jsxRuntime.jsx("button", {
        onClick: onClick,
        "data-supertokens": "buttonBase backButton",
        children: t("GO_BACK"),
    });
}
...
function LogoutButton({ onClick }) {
    ...
    return jsxRuntime.jsxs("button", {
        onClick: onClick,
        "data-supertokens": "buttonBase logoutButton",
        children: [
...
const AccessDeniedScreen$2 = (props) => {
        ...
        children: jsxRuntime.jsx("div", {
            ...
            children: jsxRuntime.jsxs("div", {
                ...
                children: [
                    ...
                    jsxRuntime.jsx("div", { "data-supertokens": "headerTitle", children: t("ACCESS_DENIED") }),
...
const AccessDeniedThemeWithOverride = uiEntry.withOverride("SessionAccessDenied", AccessDeniedScreen$2);
const AccessDeniedScreenTheme = (props) => {
    ...
    return jsxRuntime.jsx(ThemeBase, {
        ...
        children: jsxRuntime.jsx(AccessDeniedThemeWithOverride, { ...props }),
    });
};

const defaultTranslationsSession = {
    en: {
...
const AccessDeniedScreen$1 = (props) => {
    const recipeComponentOverrides = props.useComponentOverrides();
    const navigate = props.navigate ?? uiEntry.UI.getReactRouterDomWithCustomHistory()?.useHistoryCustom();
    return jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, {
        ...
        children: jsxRuntime.jsx(uiEntry.FeatureWrapper, {
            ...
            useShadowDom:
                props.useShadowDom ?? genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom,
...
class SessionPreBuiltUI extends uiEntry.RecipeRouter {
    recipeInstance;
    static instance;
    ...
    static getInstanceOrInitAndGetInstance() {
        if (SessionPreBuiltUI.instance === undefined) {
            const recipeInstance = types.Session.getInstanceOrThrow();
    ...
    getFeatures = (
        ...
        _useComponentOverrides = componentOverrideContext.useContext
    ) => {
        return {};
    };
    ...
    static AccessDeniedScreen = (prop = {}) => this.getFeatureComponent("accessDenied", prop);
